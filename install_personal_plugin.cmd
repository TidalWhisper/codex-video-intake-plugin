...
set "SRC_PLUGIN=%PACKAGE_ROOT%plugins\codex-video-pipeline-plugin\"
if not exist "%SRC_PLUGIN%.codex-plugin\plugin.json" (
  ...
  echo.
  echo Make sure you extracted the package as:
  echo         codex-video-intake-plugin\plugins\codex-video-pipeline-plugin\
  pause
  exit /b 1
)
